                ...
                <main >
                    ...
                    <section style={{display:'flex', justifyContent: 'end', alignItems: 'center', width: '100w', height: '100vh', marginRight: '20em', marginBottom: '7em'}}>
                        <form onSubmit={this.login} style={{display: 'flex', margin: 0, alignItems: 'center', flexDirection: 'column'}}>
                            ...
                            <h2 style={{textAlign:'center', fontSize: 20, fontWeight: 'bold', textTransform: 'uppercase', marginBottom: '3em', textAlign: 'center'}}>Faça seu cadastro para acessar a plataforma</h2>
                            ...
                            <input
                                ...
                                onChange={this.atualizaState}
                                placeholder = '* * * * * * * * *'
                                style={{marginBottom: 30, border: 0,  width: 350, height: 30, borderBottomWidth: 1, borderBottomColor: '#FE0000', borderStyle: 'solid', fontWeight: 'bold',  textTransform: 'uppercase', marginBottom: '2em'}}
                            />
                        
                            <button type="submit" style={{border: 0, width: 140, height: 35, backgroundColor: '#FE0000', borderRadius: 4, color: 'white', fontWeight:'bold', textTransform: 'uppercase', marginTop: '3em'}}>Cadastrar</button>

                            <p style={{marginTop: '3em'}}>Ja tem uma conta? <a style= {{fontWeight: 'bold', color: "#005FFF", textDecoration: 'none', display: 'inline'}} href = "login">Faça login</a></p> 
                        </form>
                    </section>
                </main>
            </div>
